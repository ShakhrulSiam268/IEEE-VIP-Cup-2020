...
parser.add_argument("--train_dir_day", type=str, required=False, default='./dataset/')
parser.add_argument("--train_dir_night", type=str, required=False, default='./dataset/')
...
train_dir_day = args.train_dir_day
train_dir_night = args.train_dir_night
...
try:
    ...
    create_txt_file('train', True, extention = [train_dir_day,train_dir_night])
